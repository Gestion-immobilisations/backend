...
# -*- coding: utf-8 -*-
"""
Modèle représentant un rôle utilisateur dans le système RBAC
"""
...
class Role(Base):
    """
    Modèle représentant un rôle utilisateur (ADMIN, DG, COMPTABLE, TECHNICIEN, CAISSE)
    """
    __tablename__ = "roles"
    ...
    # ✅ Relations CORRIGÉES - Utiliser des chaînes pour les références
    permissions = relationship(
        "Permission",  # ✅ Chaîne, pas un import direct
        secondary="role_permissions",  # ✅ Nom de la table
    ...
    # ✅ CORRECTION CRITIQUE - Utiliser une chaîne avec lazy='select'
    dashboard_widgets = relationship(
        "DashboardWidget",  # ✅ Chaîne, pas un import direct
        back_populates="role",
        cascade="all, delete-orphan",
        lazy="select"  # ✅ select au lieu de selectin pour éviter les problèmes
    )
